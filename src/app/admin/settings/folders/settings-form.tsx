    ...
    <div className="bg-white rounded border p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mb-4">
          Full Windows paths used by the automated diary batch processor and the Upload Diary page.
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            ...
            />
            <p className="text-xs text-gray-400">Uploaded and new diary images are placed here before processing</p>
          </div>
          <div className="space-y-1">
